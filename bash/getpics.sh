...
#Fetch the pics.tgz file from the internet and if the download is successful change directories
#to where it will be extracted
wget -P ~/public_html/pics/  https://zonzorp.net/pics.tgz && cd ~/public_html/pics


#Extract the file and if that command completes without error, go up one directory
tar -xvzf pics.tgz && cd .. 

#remove the downloaded file now that it's been extracted successfully
